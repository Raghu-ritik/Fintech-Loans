    ...
    <div class="row g-6">
                              ...
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->user_detail->first_name ?> <?php echo $opportunity->user_detail->last_name ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="$<?php echo $opportunity->Loan_amount ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->user_detail->first_name ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->close_date ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Applicant_Type__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->user_detail->userID ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->Reason_for_loan ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-12">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Opportunity_Origin__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-12">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DNB_Scoring_Rate__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-12">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Current_Balance__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-12">
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->Pay_frequency ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Summary_Total__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Total_Repayment_Amount__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Rent_Mortgage__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Loan_Amount__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Summary_Expenses__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Income_source_is_a_government_benefit__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Summary_Income__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Income_source_is_other_income_549__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Bank_Report_Gov_Benefit__c ?>">
                                </div>
                              </form>
                            </div>
                          </div>
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Deposits_since_last_dishonour__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->most_recent_loan_has_no_repayments__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Largest_income_Src_Avg_freq__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->income_DP200_spend_on_high_risk_merch__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Largest_income_Src_last_payment_amt__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Courts_and_Fines_providers__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Deposits_since_last_SACC_dishonour__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Average_monthly_amount_of_Courts_and_Fin__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  <label for="formGroupExampleInput">Deposits since last SACC dishonour</label>
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Deposits_since_last_dishonour__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->SACC_commitments_due_next_month__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_Total_Monthly_Benefit_Income__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Total_monthly_credits__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_Dishonours_Across_Primary_Acct_244__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->agency_collection_providers__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_No_Direct_Debits_On_Primary_Acct_355__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Collection_agency_transactions__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Hardship_Indicator_Gambling__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->DP_Budget_Management_Services__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->DP_Monthly_rent_amount_236__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Amount_of_SACC_commitments_due__c ?>">
                                </div>
                              </form>
                            </div>
                          </div>
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_enders_with_uncleared_dishonours_233__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Opp_number__C ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" value="<?php echo $opportunity->opportunity->Primary_regular_benefit_frequency__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Multiple_Lenders_Hardship__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" 
                                    value="<?php echo $opportunity->opportunity->Last_pay_date_for_largest_inc_src_302__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Deposit_spent_on_DOD__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" 
                                    value="<?php echo $opportunity->opportunity->Next_pay_date_for_largest_income_source__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_Monthly_avg_of_SACC_repayments__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" 
                                    value="<?php echo $opportunity->opportunity->Frequency_for_largest_income_source__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Monthly_ongoing_financial_commitments__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" 
                                    value="<?php echo $opportunity->opportunity->Primary_regular_benefit_last_pay_date__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_Primary_income_frequency__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" 
                                    value="<?php echo $opportunity->opportunity->Primary_regular_benefit_monthly_amount__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->DP_Primary_income_last_pay_date__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput" 
                                    value="<?php echo $opportunity->opportunity->loan_dishonours__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Total_monthly_income_ongoin_Reg_231__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->opportunity->Courts_and_Fines_transactions__c ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                            ...
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->Created_on ?>">
                                </div>
                              </form>
                            </div>
                            <div class="col-6">
                              <form>
                                <div class="form-group mb-3">
                                  ...
                                  <input type="text" class="form-control" id="formGroupExampleInput"
                                    value="<?php echo $opportunity->Updated_on ?>">
                                </div>
                              </form>
                            </div>
                          </div>
     ...
     <div class="col-md-4 col-12">
       <div class="card p-4">
        ...
        <button id="refresh_loan_analyze" value="<?php echo $opportunity->opportunity->opp_id ?>">Refresh</button>
